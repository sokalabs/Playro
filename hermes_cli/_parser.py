...
def build_top_level_parser():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "previews, no session_id line. Tool use is disabled by default; "
            "memory, rules, and AGENTS.md in the CWD are loaded as normal. "
            "Pass --toolsets only for trusted prompts."
        ),
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Applies to -z/--oneshot and --tui; one-shot mode enables no tools unless this is set."
        ),
    )
    parser.add_argument(
        "--resume",
