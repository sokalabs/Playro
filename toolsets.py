...
TOOLSETS = {
    ...
    "curator-dry-run": {
        "description": "Read-only skill inspection tools for curator preview runs",
    ...
    "browser-cdp": {
        "description": "Opt-in allowlisted Chrome DevTools Protocol helper for narrow browser operations not covered by normal browser tools",
        "tools": ["browser_cdp"],
        "includes": []
    },
    ...
    "hermes-webhook": {
        "description": (
            ...
            "No tools are enabled by default because signed webhook payload "
            "contents can still be attacker-controlled; opt in with "
            "platform_toolsets.webhook when a route needs specific tools."
        ),
        "tools": [],
        "includes": []
    },
