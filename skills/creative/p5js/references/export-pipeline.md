...
async function captureFrames(htmlPath, outputDir, options) {
  ...
  // Serve htmlPath from a project-local localhost server and block external
  // requests unless they are explicitly trusted. Do not load generated
  // sketches through file:// or disable browser web security.
  ...
  await page.goto(localhostSketchUrl, {
