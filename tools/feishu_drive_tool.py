...
from tools.feishu_tool_auth import authorize_file_access
...
def _handle_list_comments(args: dict, **kwargs) -> str:
    ...
    auth_error = authorize_file_access(file_type, file_token, "feishu_drive_list_comments")
...
def _handle_list_replies(args: dict, **kwargs) -> str:
    ...
    file_type = args.get("file_type", "docx") or "docx"
    auth_error = authorize_file_access(file_type, file_token, "feishu_drive_list_comment_replies")
    if auth_error is not None:
        return auth_error
...
def _handle_reply_comment(args: dict, **kwargs) -> str:
    ...
    file_type = args.get("file_type", "docx") or "docx"
    auth_error = authorize_file_access(file_type, file_token, "feishu_drive_reply_comment")
    if auth_error is not None:
        return auth_error
...
def _handle_add_comment(args: dict, **kwargs) -> str:
    ...
    file_type = args.get("file_type", "docx") or "docx"
    auth_error = authorize_file_access(file_type, file_token, "feishu_drive_add_comment")
    if auth_error is not None:
        return auth_error
