...
def _vision_tool_output_exposes_image_bytes() -> bool:
    """Return False on API-server sessions where tool output is streamed to clients."""
    try:
    ...
    return (platform or "").strip().lower() != "api_server"
...
def _handle_vision_analyze(args: Dict[str, Any], **kw: Any) -> Awaitable[str]:
    ...
    try:
        ...
        if (
            ...
            and _vision_tool_output_exposes_image_bytes()
        ):
            logger.info(
