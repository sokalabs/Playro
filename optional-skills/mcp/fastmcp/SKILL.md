...
- `scripts/scaffold_fastmcp.py` - copy a starter template and safely render the server name placeholder
...
If copying manually, replace `__SERVER_NAME__` with a quoted Python string literal such as `"Acme API"`.
