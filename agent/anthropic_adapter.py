...
def _base_url_needs_context_1m_beta(base_url: str | None) -> bool:
    ...
    return base_url_host_matches(normalized, "azure.com") or base_url_host_matches(
        normalized, "openai.azure.com"
    )
...
def build_anthropic_client(
    ...
    *,
    ...
    if normalized_base_url:
        ...
        _is_azure_endpoint = _base_url_needs_context_1m_beta(normalized_base_url)
